...
B --> C[Document Ingestion Module]

C --> D[Document Analyzer]

D --> E[Knowledge Extraction Engine]

E --> F[Organizational Memory Store]

F --> G[Knowledge Graph Engine]

G --> H[React Flow Visualization]

F --> I[AI Decision Firewall]

I --> J[Risk Prediction Engine]

J --> K[Insights & Recommendations]

K --> B

L[Decision Timeline] --> F
...
![AI Decision Firewall](screenshots/decision-firewall.png)
