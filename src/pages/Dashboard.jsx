...
const incidents = [
  { title: 'API latency spike', team: 'Platform', severity: 'High', time: '12m ago' },
  { title: 'Support backlog surge', team: 'Ops', severity: 'Medium', time: '37m ago' },
  { title: 'Model confidence drift', team: 'AI', severity: 'High', time: '1h ago' },
];

const insights = [
  {
    title: 'Priority intervention',
    description: 'Escalate the API latency trend before it impacts SLA commitments.',
  },
  {
    title: 'Cross-team automation',
    description: 'Route recurring support issues to bot-assisted workflows to reduce overload.',
  },
  {
    title: 'Risk mitigation',
    description: 'Rebalance monitoring thresholds for model drift signals to improve response speed.',
  },
];
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-400 sm:text-base">
                Monitor operational risk, detect emerging patterns, and act on AI-generated recommendations in real time.
              </p>
            </div>
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className={`rounded-2xl bg-white/5 p-2 ${metric.accent}`}>
                    <Icon className="h-5 w-5" />
                  </div>
                </div>
                <p className="mt-4 text-sm text-slate-400">{metric.change}</p>
              </article>
            );
          })}
        </section>
        ...
        <section className="grid gap-6 xl:grid-cols-[1.4fr_0.9fr]">
          <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-6 shadow-xl shadow-black/10 backdrop-blur">
            <div className="mb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-400">Latest signals requiring attention</p>
              </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-6 shadow-xl shadow-black/10 backdrop-blur">
            <div className="mb-4">
              ...
              <p className="text-sm text-slate-400">Recommended actions from the engine</p>
            </div>

            <div className="space-y-3">
              {insights.map((insight) => (
                <div key={insight.title} className="rounded-2xl border border-cyan-400/10 bg-cyan-500/5 p-4">
